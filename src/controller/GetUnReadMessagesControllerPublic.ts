 ...
 * */
class GetUnReadMessagesControllerPublic {
    ...
    async handleRequest(req: Request, res: Response) {
        try {
            const validatedInput = joi.attempt({ query: req.query, params: req.params}, GetUnReadMessagesControllerPublic.requestSchema());
            const request: GetTransactionRequest = GetUnReadMessagesControllerPublic.getValidatedRequest(validatedInput);
...
export default GetUnReadMessagesControllerPublic;