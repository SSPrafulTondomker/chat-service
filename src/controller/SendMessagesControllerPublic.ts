 ...
 * */
class SendMessagesControllerPublic {
    ...
    async handleRequest(req: Request, res: Response) {
        try {
            const validatedInput = joi.attempt({ query: req.query, params: req.params}, SendMessagesControllerPublic.requestSchema());
            const request: GetTransactionRequest = SendMessagesControllerPublic.getValidatedRequest(validatedInput);
...
export default SendMessagesControllerPublic;